...
void curses_table::print_wait()
{
	...
	if(is_tracer_view)
	{
		...
		print_line_centered("Note: in order to see any data here, you need to push tracers to deepsys from your app as described here: XXX.", 2);
	}
	else
	{
...
//
deepsys_table_action curses_table::handle_input(int ch)
{
	if(m_data == NULL)
	{
