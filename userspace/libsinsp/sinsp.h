...
public:
	enum flags
	{
		...
		FL_HIDDEN = (1 << 1),	///< This filter check class won't be shown by stuff like the -l deepsys command line switch.
	};
...
public:
	...
	*/
	...
	/*!
	  ...
	  creating them can increase deepsys's startup time. Moreover, they contain
	...
	*/
	...
	/*!
	  ...
	  \param filter the filter string. Refer to the filtering language
	   section in the deepsys website for information about the filtering
	   syntax.
	...
	*/
	...
	/*!
	  ...
	  the inspector filters out events about deepsys itself.
	*/
	...
	*/
	...
	/*!
	  \brief Set whether Deepsys should resolve hostnames and port protocols or not.

	  \note Deepsys can use the system library functions getservbyport and so to
	...
	*/
	...
	/*!
	  ...
	  \note Moved to the inspector due to deepsys#426 issue
