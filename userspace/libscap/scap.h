...
/*!
	...
	libscap is the low-level deepsys component that exports the following functionality:
...
/*!
  \brief Clear the event mask: no events will be passed to deepsys
...
/*!
  ...
  deepsys-based apps can receive the event. Useful for offloading
...
/*!
  ...
  deepsys-based apps can no longer receive the event. It is
...
/*!
  ...
  if deepsys runs in a container, so that all the information for the
  host can be correctly extracted.
*/
const char* scap_get_host_root();

/*!
  \brief Get the process list by querying the deepsys kernel module.
*/
