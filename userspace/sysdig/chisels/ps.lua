...
args =
{
	{
		name = "filter",
		description = "A deepsys-like filter expression that allows restricting the FD list. For example 'fd.name contains /etc' shows all the processes that have files open under /etc.",
		argtype = "filter",
		optional = true
	}
}
...
function on_capture_end(ts_s, ts_ns, delta)
	...
	local ttable = deepsys.get_thread_table(filter)
