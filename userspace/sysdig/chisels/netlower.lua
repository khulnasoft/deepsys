...
USAGE: deepsys -c netlower min_ms
   eg,

   deepsys -c netlower 1000				  # show network I/O slower than 1000 ms.
   deepsys -c netlower "1 disable_colors"	# show network I/O slower than 1 ms. w/ no colors
   deepsys -c netlower 1000				  # show network I/O slower than 1000 ms and container output
...
-- Chisel description
description = "Trace network I/O slower than a threshold, or all network I/O. This chisel is compatible with containers using the deepsys -pc or -pcontainer argument, otherwise no container information will be shown. (Blue represents a process running within a container, and Green represents a host process)"
