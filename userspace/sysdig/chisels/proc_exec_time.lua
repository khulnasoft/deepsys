--[[
USAGE: deepsys -c proc_exec_time
   eg,

   deepsys -c proc_exec_time				 # show processes that have finished
   deepsys -c proc_exec_time disable_colors" # show processes that have finished w/ no colors
   deepsys -pc -c proc_exec_time			 # show processes that have finished and container output

Copyright (C) 2014 KhulnaSoft, Ltd.
