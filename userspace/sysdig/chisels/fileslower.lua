...
USAGE: deepsys -c fileslower min_ms
   eg,

   deepsys -c fileslower 10					# show file I/O slower than 10 ms
   deepsys -c fileslower 0					# show all file I/O
   deepsys -c fileslower "1 disable_colors"	# show file I/O slower than 1 ms. w/ no colors
   deepsys -pc -c fileslower 0				# show all file I/O and container output

By default this skips file I/O to /dev. Modify the skip_dev variable in this
chisel to change this behavior.

Note: The file I/O traced is those matched by the deepsys filter:
...
-- Chisel description
description = "Trace file I/O slower than a threshold, or all file I/O. This chisel is compatible with containers using the deepsys -pc or -pcontainer argument, otherwise no container information will be shown. (Blue represents a process running within a container, and Green represents a host process)";
...
function on_init()
	...
	print_container = deepsys.is_print_container_data()
