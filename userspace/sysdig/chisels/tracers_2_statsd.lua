...
-- Chisel description
description = "Converts deepsys span duration data into statsd metrics and pipes them to the given statsd server. See https://github.com/khulnasoft/deepsys/wiki/Tracers for more information.";
