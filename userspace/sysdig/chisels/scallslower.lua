...
USAGE: deepsys -c scallslower min_ms
   eg,

   deepsys -c scallslower 1000			   # show syscalls slower than 1000 ms.
   deepsys -c scallslower "1 disable_colors" # show syscalls slower than 1 ms. w/ no colors
   deepsys -pc -c scallslower 1000		   # show syscalls slower than 1000 ms and container output
...
-- Chisel description
description = "Trace syscalls slower than a threshold milliseconds. This chisel is compatible with containers using the deepsys -pc or -pcontainer argument, otherwise no container information will be shown. (Blue represents a process running within a container, and Green represents a host process)";
