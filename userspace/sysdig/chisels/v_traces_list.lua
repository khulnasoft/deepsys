...
view_info =
{
	...
	tips = {
		"Traces are deepsys's super easy way to delimit portions of your code so that deepsys can measure how long they take and tell you what's happening inside them. You can learn about tracers at https://github.com/khulnasoft/deepsys/wiki/Tracers.",
