...
-- Chisel description
description = "Show the top process defined by the highest CPU utilization. This chisel is compatible with containers using the deepsys -pc or -pcontainer argument, otherwise no container information will be shown."
...
function on_capture_start()
	islive = deepsys.is_live()
	vizinfo.output_format = deepsys.get_output_format()
